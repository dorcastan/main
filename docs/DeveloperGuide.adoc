...
// TODO: Revamp this completely. Explain the autotag package and available methods.
The autotag package is structured in the following manner: _(To be completed.)_

.Class diagram for seedu.mark.model.autotag package
image::AutotagPackageDiagram.png[]

`AutotagController` is the primary class that facilitates the autotag mechanism.
It stores and manages a list of `SelectiveBookmarkTaggers` which apply tags to
bookmarks if they match specific criteria.
...
// TODO: Explain SelectiveBookmarkTaggers
